...
blob_fixups: blob_fixups_user_type = {
    ('odm/lib64/libCOppLceTonemapAPI.so', 'odm/lib64/libYTCommon.so', 'odm/lib64/lib_rectify.so', 'odm/lib64/libaps_frame_registration.so'): blob_fixup()
    ...
    'odm/lib64/libsnpe_dsp_domains_v2.so': blob_fixup()
        .clear_symbol_version('remote_handle64_close')
        .clear_symbol_version('remote_handle64_invoke')
        .clear_symbol_version('remote_handle64_open')
        .clear_symbol_version('remote_register_dma_handle'),
    ('odm/etc/libnfc-mtp-SN100.conf_20161', 'odm/etc/libnfc-mtp-SN100.conf_20351'): blob_fixup()
